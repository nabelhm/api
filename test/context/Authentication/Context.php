...
class Context implements SnippetAcceptingContext, KernelAwareContext
{
    ...
    /**
     * @Given the system should have the following authentication profiles:
     *
     * @param PyStringNode $body
     *
     */
    public function theSystemShouldHaveTheFollowingAuthenticationProfiles(PyStringNode $body)
    {
        /** @var CollectProfilesTestWorker $collectProfilesTestWorker */
        $collectProfilesTestWorker = $this->kernel
            ->getContainer()
            ->get('muchacuba.authentication.collect_profiles_test_worker');
        ...
        $this->rootContext->ignoreState('Muchacuba\Authentication\Profile');
    }
}