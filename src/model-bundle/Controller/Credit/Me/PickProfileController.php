...
namespace Muchacuba\ModelBundle\Controller\Credit\Me;

use JMS\DiExtraBundle\Annotation as DI;
use Muchacuba\Credit\PickProfileApiWorker;
...
class PickProfileController
{
     ...
     *     "pickProfileApiWorker" = @DI\Inject("muchacuba.credit.pick_profile_api_worker"),
     * })
     */
