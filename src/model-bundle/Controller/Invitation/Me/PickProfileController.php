...
namespace Muchacuba\ModelBundle\Controller\Invitation\Me;

use JMS\DiExtraBundle\Annotation as DI;
use Muchacuba\Invitation\PickProfileApiWorker;
...
class PickProfileController
{
     ...
     *     "pickProfileApiWorker" = @DI\Inject("muchacuba.invitation.pick_profile_api_worker"),
     * })
     */
    ...
    /**
     * @Req\Route("/invitation/me/pick-profile")
     * @Req\Method({"GET"})
     *
     * @return JsonResponse
     */
